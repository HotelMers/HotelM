...
exports.Room = mongolass.model('Room', {
    ...
    type: { type: 'string', required: true },  // big是大房，single是单人房，double是双人房
...
exports.EmptyRoomNumber = mongolass.model('EmptyRoomNumber', {
  ...
  bigRoom : { type: 'int', required: true },
  singleRoom: { type: 'int', required: true },
  doubleRoom: { type: 'int', required: true }
})
